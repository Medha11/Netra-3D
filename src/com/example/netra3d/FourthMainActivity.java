...
public class FourthMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String path ="/mnt/sdcard/netra3d/stage3.blend";
		
		String path2="/mnt/extsd/netra3d/stage3.blend";
		
		String path3=Environment.getExternalStorageDirectory()+"/netra3d/stage3.blend";
